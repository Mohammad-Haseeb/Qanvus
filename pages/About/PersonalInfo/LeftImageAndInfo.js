        ...
        <>
            <div className="vl" style={{ borderLeft: border }}>
                ...
                {/* {props.biography.map((object,index)=>{
                    return(index >0 ? <p className="AboutPersonInfoDetaial" key={index}>{object["Para"]}</p>:<p className="AboutPersonInfoDetaial" style={{ marginTop: "100px" }} key={index}>{object["Para"]}</p>)
                })} */}
