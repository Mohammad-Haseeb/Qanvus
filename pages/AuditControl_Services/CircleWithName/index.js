...
const AuditFirstCircleRowWithName = ({ data }) => {
    return (
        <>
                ...
                <Row justify="space-around" >
                    ...
                    <Col align="center" xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 4 }} xl={{ span: 4 }}>
                        ...
                        <h1 style={{ lineHeight: "normal" }}>{data["Sixth_circular_Name"][0]["First-Line"]}<br />
                            {data["Sixth_circular_Name"][1]["Second-Line"]}<br />
                            {data["Sixth_circular_Name"][2]["Third-Line"]}
                        </h1 >
                    </Col>
                </Row>
            </div>
            ...
            <div className="secondRowOfIcons" style={{ marginTop: "70px", fontFamily: 'GothamBold' }}>
                <Row justify="space-around" >
                    <Col align="center" xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 4 }} xl={{ span: 4 }} >
                        ...
                        <h1 style={{ lineHeight: "normal" }}>{data["Seven_circular_Name"][0]["First-Line"]}<br />
                            {data["Seven_circular_Name"][1]["Second-Line"]}<br />
                            {data["Seven_circular_Name"][2]["Third-Line"]}</h1>
                    </Col>
                    <Col align="center" xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 4 }} xl={{ span: 4 }} >
                        <div className="dot">
                    ...
                    <Col align="center" xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 4 }} xl={{ span: 4 }}>
                        ...
                        <h1 style={{ lineHeight: "normal" }}>{data["Eleventh_circular_Name"][0]["First-Line"]}<br />
                            {data["Eleventh_circular_Name"][1]["Second-Line"]}<br />
                            {data["Eleventh_circular_Name"][2]["Third-Line"]}</h1>
                    </Col>
...
export default AuditFirstCircleRowWithName;