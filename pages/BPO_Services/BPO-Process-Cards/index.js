...
import lastIcon from './../../../public/BPO/Orange_Icon_5.png';

const BPOProcessIcons = ({ name, images }) => {
    return (
        <>
    ...
    return (
        <>
            <div className="processIconsMainContainer" style={{ marginTop: "100px", marginBottom: "100px" }}>
                <Row justify="center">
                    <Col align="center" xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 18 }} lg={{ span: 15 }} xl={{ span: 12 }} xxl={{ span: 10 }} >
                        <div className="AdvisoryProcessIconImageWrapeer">
                            <img className="AdvisoryProcessIconImage" src={lastIcon.src} alt="First Icon Image" />
                        </div>
                        <div><h1 style={{ marginTop: "20px", marginBottom: "30px", fontFamily: "GothamBold" }}>Live Operations</h1></div>
                        <div>
...
export default BPOProcessIcons;