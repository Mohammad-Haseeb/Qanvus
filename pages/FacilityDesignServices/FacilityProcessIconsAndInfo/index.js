...
import lastIcon from './../../../public/FacilityAndDesignServices/Green_Icon_5.png';

const FacilityDesignProcessIcons = ({ name, images }) => {
    return (
        <>
...
export default FacilityDesignProcessIcons;